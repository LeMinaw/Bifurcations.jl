...
module Bifurcations
    ...
    function __init__()
        ...
        colormap = Gradient(RGB(0,0,0), RGB(1,0,0))
        # colormap = Gradient(RGB(1,0,0), RGB(1,1,1))

        # plot(pop, colormap; name="precomp", sx=128, sy=128) # Precompilation
